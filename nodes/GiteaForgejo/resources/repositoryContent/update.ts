...
const showOnlyForRepositoryContentUpdate = {
	operation: ['update'],
	resource: ['repositoryContent'],
};

export const repositoryContentUpdateDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: showOnlyForRepositoryContentUpdate,
		},
	},
	{
		displayName: 'SHA',
		...
		required: true,
		default: '',
		description: 'Current SHA of the file to update',
		displayOptions: {
			show: showOnlyForRepositoryContentUpdate,
		},
		routing: {
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Original file path to move/rename from',
				routing: {
					request: {
						body: {
