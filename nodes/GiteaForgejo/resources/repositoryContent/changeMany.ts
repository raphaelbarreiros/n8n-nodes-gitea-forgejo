...
const showOnlyForRepositoryContentChangeMany = {
	operation: ['changeMany'],
	resource: ['repositoryContent'],
};

export const repositoryContentChangeManyDescription: INodeProperties[] = [
	{
		displayName: 'Files',
		name: 'files',
		type: 'json',
		required: true,
		default: '[]',
		description: 'Array of change file operations',
		displayOptions: {
			show: showOnlyForRepositoryContentChangeMany,
		},
		routing: {
			send: {
				type: 'body',
